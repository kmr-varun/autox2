...
const TimeInterval: React.FC = () => {
  const [triggerType, setTriggerType] = useState<'days' | 'weeks' | 'months'>('days');
  ...
  const getFormattedText = () => {
    ...
    const unitText = triggerType === 'days' ? 'day' : triggerType === 'weeks' ? 'week' : 'month';
  ...
  const handleTriggerTypeChange = (selectedTriggerType: 'days' | 'weeks' | 'months') => {
    setTriggerType(selectedTriggerType);
